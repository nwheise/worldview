...
- An info/attribution box in the bottom-left corner links to [thetruesize.com](https://thetruesize.com) (inspiration), the GitHub repo, and the issues page for feedback.
